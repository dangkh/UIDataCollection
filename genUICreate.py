...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Dùng thông tin cũ"))
        self.pushButton_2.setText(_translate("Form", "Reset Form"))
        self.pushButton_3.setText(_translate("Form", "Lấy time hiện tại"))
