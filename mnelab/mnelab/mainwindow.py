...
from mnelab.mnelab.io import writersName
from mnelab.mnelab.io.xdf import get_xml, get_streams
...
class OtherMainWindow(QMainWindow):
    ...
    def __init__(self, model):
        ...
        for ext, description in writersName.items():
